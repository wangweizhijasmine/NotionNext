...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NINA', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '正在现代性的淤泥里跋涉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-ruby-eight-26.vercel.app/', // 网站地址

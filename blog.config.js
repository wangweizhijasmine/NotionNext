...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '海鸥妮娜', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '莫思身外无穷事，且尽生前有限杯', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://thecherryorchard.vercel.app/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '无灯可看，水从教正月半, 铜驼故老，说著宣和似天宝,横批：曾湖上住',
